...
export default function Home(){
  ...
  return <div className="app-shell">
    ...
    <main className="workspace">
      ...
      <footer className="workspace-footer"><span>CODEFRONT <span className="muted">/ EARLY ACCESS 0.2</span></span><button onClick={()=>setManual(true)}>不确定怎么写？随时翻开手册 <ArrowUpRight size={14}/></button></footer>
    </main>
